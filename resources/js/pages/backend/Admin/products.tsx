...
export default function Products({ products, categories, filters }: Props) {
    const maxClicks = Math.max(
        ...products.data.map((p) => p.total_clicks || 0),
        1,
    );
                    ...
                    <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                        ...
                        <div className="flex flex-col gap-4 p-4 sm:p-6 md:flex-row md:items-start md:justify-between">
                            ...
                            <div className="flex gap-3">
                                <select
                                    ...
                                    className="flex-1 rounded-lg border border-gray-200 bg-white px-3 py-2.5 text-xs font-medium text-gray-600 transition-colors outline-none hover:bg-slate-50 md:flex-none md:px-4"
                                >
                        ...
                        <div className="divide-y divide-gray-50 px-4 pb-4 md:hidden">
                            {products.data.map((product: Product) => (
                                <div
                                    key={product.id}
                                    className="group py-4 transition-colors hover:bg-slate-50/50"
                                >
