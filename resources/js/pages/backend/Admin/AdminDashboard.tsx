        ...
        <>
            ...
            <div className="flex">
                ...
                <div className="container bg-white  font-inter text-gray-900 p-8">
                    ...
                    <div className="p-8 bg-white rounded-2xl shadow-sm border border-gray-100  mx-auto mb-8">
                        <div className="relative h-[400px] w-full">
                            <div className="absolute inset-0 flex flex-col justify-between text-[11px] text-gray-400 font-medium">
                            <div className="flex items-center gap-4">
                                <span className="w-8 text-right">1000</span>
                                <div className="flex-1 border-t border-dashed border-gray-100" />
                            </div>
                            <div className="flex items-center gap-4">
                                <span className="w-8 text-right">750</span>
                                <div className="flex-1 border-t border-dashed border-gray-100" />
                            </div>
                            <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-4">
                                <span className="w-8 text-right">250</span>
                                <div className="flex-1 border-t border-dashed border-gray-100" />
                            </div>
                            <div className="flex items-center gap-4">
                            ...
                            <div className="absolute inset-0 left-12 right-0 bottom-0 top-0 overflow-hidden">
                            <svg
                            ...
                            <div className="absolute -bottom-8 left-12 right-0 flex justify-between text-[11px] text-gray-400 font-semibold uppercase tracking-wider">
                            <span>Mon</span>
                            <span>Tue</span>
                            <span>Wed</span>
                            <span>Thu</span>
