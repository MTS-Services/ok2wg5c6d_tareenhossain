...
export default function Category() {
    ...
    const [categories, setCategories] =
        useState<PaginatedCategories>(initialCategories);
    ...
    const filteredCategories = useMemo(() => {
        ...
        return categories.data.filter((row: CategoryRow) =>
                ...
                <div className="container mt-12 bg-white p-8 font-inter text-gray-900 lg:mt-0">
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        ...
                        <Button
                            ...
                            variant="default"
                            className="flex cursor-pointer items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 transition-all hover:bg-blue-600"
                        >
                            <svg
                                className="h-4 w-4"
                                fill="none"
            ...
            >
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="rounded-md border border-gray-100 bg-gray-50 px-3 py-2">
                        ...
                        <p
                            className="mt-0.5 font-mono text-sm break-all text-gray-800"
                            aria-live="polite"
                        >
                            {categorySlugPreview}
                        </p>
                    ...
                    <div className="flex justify-end gap-3">
                        <Button
                            variant="outline"
                            onClick={closeModal}
                            className="cursor-pointer rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-black"
                        >
                            Cancel
                        </Button>
                        <Button
                            ...
                            disabled={!canSave}
                            variant="default"
                            className="cursor-pointer rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600 disabled:opacity-50 disabled:hover:bg-blue-500"
                        >
                            {categoryFormBusy
                                ? 'Saving…'
                                : modalMode === 'edit'
